...
@lazySingleton
class FetchRtvOrdersUseCase
    extends UseCase<PaginatedRtvOrderResponseEntity, FetchRtvOrdersParams> {
  final OrderRepository repository;

  FetchRtvOrdersUseCase(this.repository);

  @override
  Future<Either<Failure, PaginatedRtvOrderResponseEntity>> call(
    FetchRtvOrdersParams params,
  ) async {
    return await repository.fetchRtvOrders(
      page: params.page,
...
class FetchRtvOrdersParams extends Equatable {
  final int page;
