...
class ExtraMileagePermissionSectionWidget extends StatefulWidget {
  final String title;
  ...
  const ExtraMileagePermissionSectionWidget({
    super.key,
    required this.title,
  ...
  @override
  State<ExtraMileagePermissionSectionWidget> createState() =>
      _ExtraMileagePermissionSectionWidgetState();
}

class _ExtraMileagePermissionSectionWidgetState
    extends State<ExtraMileagePermissionSectionWidget> {
  @override
  void initState() {
    super.initState();
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            BlocBuilder<StaffExtraMileagePermissionBloc,
                StaffExtraMileagePermissionState>(
              builder: (context, state) {
                if (state is StaffExtraMileagePermissionLoading) {
                  return const Center(child: CircularProgressIndicator());
                } else if (state is StaffExtraMileagePermissionError) {
                  return Center(
                    child: Text(
                      'Error: ${state.message}',
                ...
                } else if (state is StaffExtraMileagePermissionEmpty) {
                  return const Center(
                      child: Text('No permissions available'));
                } else if (state is StaffExtraMileagePermissionLoaded) {
                    ...
                    children: [
                      ...
                      if (widget.selectedPermissions.isNotEmpty)
                        SizedBox(
                          ...
                          child: BlocBuilder<StaffExtraMileagePermissionBloc,
                              StaffExtraMileagePermissionState>(
                            builder: (context, state) {
                              final isUpdating =
                                  state is StaffExtraMileagePermissionUpdating;

                              return ElevatedButton(
                                onPressed: isUpdating ? null : widget.onSave,
