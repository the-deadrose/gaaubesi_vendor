...
class GeneralPermissionSectionWidget extends StatefulWidget {
  final String title;
  ...
  const GeneralPermissionSectionWidget({
    super.key,
    required this.title,
  ...
  @override
  State<GeneralPermissionSectionWidget> createState() =>
      _GeneralPermissionSectionWidgetState();
}

class _GeneralPermissionSectionWidgetState
    extends State<GeneralPermissionSectionWidget> {
  @override
  void initState() {
    super.initState();
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            BlocBuilder<StaffGeneralPermissionBloc,
                StaffGeneralPermissionState>(
              builder: (context, state) {
                if (state is StaffGeneralPermissionLoading) {
                  return const Center(child: CircularProgressIndicator());
                } else if (state is StaffGeneralPermissionError) {
                  return Center(
                    child: Text(
                      'Error: ${state.message}',
                ...
                } else if (state is StaffGeneralPermissionEmpty) {
                  return const Center(
                      child: Text('No permissions available'));
                } else if (state is StaffGeneralPermissionLoaded) {
                    ...
                    children: [
                      ...
                      if (widget.selectedPermissions.isNotEmpty)
                        SizedBox(
                          ...
                          child: BlocBuilder<StaffGeneralPermissionBloc,
                              StaffGeneralPermissionState>(
                            builder: (context, state) {
                              final isUpdating =
                                  state is StaffGeneralPermissionUpdating;
